      ...
      function render(rows){
        ...
        rows.forEach((r,i)=>{
          ...
          tr.innerHTML=
            ...
            '<td>'+ (r.checked_in_at?fmt(r.checked_in_at):'—') +'</td>'+
            '<td class="col-sm-hide">'+ (r.checked_out_at?fmt(r.checked_out_at):'—') +'</td>'+
            '<td>'+ statusBadge(r) +'</td>'+
            '<td class="col-sm-hide">'+ (r.checked_out_at?dur(r.checked_in_at,r.checked_out_at):'') +'</td>'+
            '<td class="col-sm-hide">'+ srcBadge(r.source) +'</td>'+
            '<td class="col-sm-hide">'+ (r.remarks && r.remarks.trim()?r.remarks:(String(r.source).toLowerCase()==='qr'?'Scanned via QR':'—')) +'</td>';
