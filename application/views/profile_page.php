                ...
                <div class="col-md-7 d-flex align-items-center">
                  ...
                  <?php
                    ...
                    $fullName = trim(implode(' ', array_filter([
                      $s->FirstName ?? '', $s->MiddleName ?? '', $s->LastName ?? '', $s->nameExtn ?? ''
                    ])));
                    if ($fullName === '') $fullName = 'Student';
                    $addr = trim(implode(', ', array_filter([
                      $s->sitio ?? '', $s->brgy ?? '', $s->city ?? '', $s->province ?? ''
                    ])));
                  ?>
                  <div>
          ...
          <div class="col-sm-12">
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body pt-3">
                <style>
                  .about-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));grid-gap:16px}
                  @media(max-width:768px){.about-grid{grid-template-columns:1fr}}
                  .about-item{background:#f9fbff;border:1px solid #e6ecf5;border-radius:12px;padding:14px 16px}
                  .about-label{font-size:.78rem;letter-spacing:.06em;text-transform:uppercase;color:#6b7b93;margin-bottom:4px}
                  .about-value{font-weight:600;color:#2c3e50}
                  .about-section-title{font-size:.9rem;font-weight:700;color:#243b53;margin:16px 0 8px}
                </style>
