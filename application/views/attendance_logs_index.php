...
<body>
<style>
.badge-course-code{font-size:0.75rem;font-weight:600;letter-spacing:0.4px}
.student-number-cell .student-name-mobile{color:#6c757d;font-size:0.85rem}
</style>
<div id="wrapper">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="year_level" class="form-control select2" data-placeholder="All year levels">
                                ...
                                <?php if (!empty($year_levels)): foreach ($year_levels as $yl):
                                    $lvl = (string)($yl->year_level ?? ''); if ($lvl === '') continue;
                                ?>
