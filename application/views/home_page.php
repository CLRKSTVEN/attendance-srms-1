...
<head>
  ...
  <style>
    :root{
      ...
      --brand-1:#3b82f6; --brand-2:#60a5fa;
      --ink:#0f2b46; --muted:#5b6c81;
      --panel:#ffffff; --ring:rgba(59,130,246,.25);
      --field:#f4f7ff; --field-bd:#d8e4ff;
    }
    ...
    .shell{min-height:100vh; display:grid; place-items:center; padding:16px}
    .frame{
    ...
    .hero-card{
      ...
      background:var(--panel); border:1px solid #e7efff;
      border-radius:18px; box-shadow:0 16px 40px rgba(59,130,246,.15);
      padding:28px;
    }
    .hero-grid{
  ...
  @media (max-width: 576px){ .pane-hero{display:none} }

    .badge-soft{
      display:inline-flex; align-items:center; gap:8px;
      padding:8px 12px; border-radius:999px;
      color:#0b3b77; font-weight:700;
      background:#e8f2ff; border:1px solid #d7e7ff; font-size:.95rem;
    }
    .hero-title{color:var(--ink); font-weight:900; line-height:1.05; margin:12px 0 10px; font-size:2.35rem}
    .hero-sub{margin:0 0 12px}
    .pane-form{
      background: linear-gradient(180deg,#f8fbff,#f0f6ff);
      padding:40px 36px; display:flex; flex-direction:column; border-left:1px solid #e6eeff;
      outline:0; 
    }
    .brand{display:flex; align-items:center; gap:12px; margin-bottom:18px; color:#0b3b77}
    .brand-logo{
      width:44px; height:44px; border-radius:12px; overflow:hidden;
      display:grid; place-items:center; background:#edf4ff; border:1px solid #d7e7ff;
    }
    .title{color:var(--ink); font-weight:900; margin:6px 0 4px; font-size:1.9rem}
    .sub{margin-bottom:14px}
    .flash{background:#fff4f4; border:1px solid #fecaca; color:#b91c1c; border-radius:10px; padding:10px 12px; font-weight:600; margin-bottom:12px}

    .form-label{font-weight:700; color:#13385e}
    .form-control{
      background:var(--field); border:1px solid var(--field-bd); color:#0e2f53;
      border-radius:10px; padding:.78rem .95rem;
    }
    .form-control::placeholder{color:#93a7c7}
    .form-control:focus{background:#fff; border-color:var(--brand-2); box-shadow:0 0 0 .22rem var(--ring); color:#0e2f53}
    .input-group-append .btn{border-color:var(--field-bd); background:#f3f7ff}

    .btn-brand{
      width:100%; border:0; border-radius:12px; padding:.95rem 1rem;
      font-weight:800; letter-spacing:.2px; color:#06223f;
    ...
    .link{color:var(--brand-1); font-weight:800; text-decoration:none}
    .link:hover{text-decoration:underline}
    .foot-note{margin-top:auto; color:#6f85a4; font-size:.85rem}
