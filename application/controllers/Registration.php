  ...
  public function index()
{
    ...
    if ($this->input->post('register')) {
        ...
        if ($recaptchaResponse === '') {
            ...
            redirect('Registration/index'); return;
        }
...
'section' => $this->input->post('section', true),
        ...
        if (!$sent) {
            ...
            redirect('Login/index'); return;
        }

        $this->session->set_flashdata('msg', '<div class="alert alert-success text-center"><b>Registration successful. Check your email for login credentials.</b></div>');
        redirect('Login/index'); return;
    }
    ...
    public function sections()
    {
        ...
        $sections = array_map(function($r){ return $r['Section']; }, $rows);
