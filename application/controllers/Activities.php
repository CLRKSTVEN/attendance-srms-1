  ...
  public function create()
{
    ...
    {
        $ok = $this->ActivitiesModel->delete((int)$id);
        redirect('activities');
    }
...
public function update($id)
{
    ...
    $this->db->where('activity_id', $id)->update('activities', $data);
...
public function majors_by_program()
{
    ...
    $majors = [];
    foreach ($q->result() as $r) { $majors[] = (string)$r->major; }
